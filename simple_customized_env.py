#!/usr/bin/env python3
"""
Simple CustomizedEnv runner without full visualization to avoid crashes
"""
...
def run_simple_visualization():
    """Run the customized environment with minimal visualization"""
    
    # Load configuration
    with open('robotarium_gym/scenarios/CustomizedEnv/config.yaml', 'r') as f:
        config = yaml.safe_load(f)
    
    # Disable visualization to avoid crashes
    ...
    print("🚀 Starting CustomizedEnv (Simple Mode)")
